...
function Init()
    ...
    m.top.loadingIndicator2 = m.top.findNode("loadingIndicator2")
    ...
    m.top.loadingIndicator2.backgroundColor = m.global.theme.background_color
    m.top.loadingIndicator2.imageUri = m.global.theme.loader_uri

    m.top.loadingIndicator2.control = "stop"
...
sub CarouselDeepLinkToDetailPage()
    ...
    ? "[CarouselDeepLinkToDetailPage] Playlist Selected==>"m.top.DeepLinkToDetailPage
...
function OnRowItemSelected()
    ...
    if m.gridScreen.focusedContent.contentType = 2 then
        ...
        m.detailsScreen.visible = true
        m.screenStack.push(m.detailsScreen)
        print "m.gridScreen.focusedContent: "; m.gridScreen.focusedContent
    end if
end function
